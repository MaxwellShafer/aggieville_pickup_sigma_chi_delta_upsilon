...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: VerifyTaskPageWidget.routeName,
          path: VerifyTaskPageWidget.routePath,
          builder: (context, params) => VerifyTaskPageWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: UnverifiedPageWidget.routeName,
          path: UnverifiedPageWidget.routePath,
          builder: (context, params) => UnverifiedPageWidget(),
        )
