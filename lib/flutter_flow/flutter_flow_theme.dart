...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF00A3E0);
  late Color secondary = const Color(0xFFFFD141);
  late Color tertiary = const Color(0xFFF9F9F9);
  late Color alternate = const Color(0xFFF5F5F5);
  late Color primaryText = const Color(0xFF002B49);
  late Color secondaryText = const Color(0xFF4A4A4A);
  late Color primaryBackground = const Color(0xFFF1F4F8);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xFF8A8D8F);
  late Color accent2 = const Color(0xFFD3D3D3);
  late Color accent3 = const Color(0xFFFFB800);
  ...
  late Color vibrantColor = const Color(0xFFEDA800);
  late Color lightVibrantColor = const Color(0xFFF8D040);
  late Color darkVibrantColor = const Color(0xFF052742);
  late Color mutedColor = const Color(0xFF8B8A8A);
  late Color lightMutedColor = const Color(0xFFD0D0C8);
  late Color darkMutedColor = const Color(0xFF545454);
}
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF7B001B);
  late Color secondary = const Color(0xFFD6A800);
  late Color tertiary = const Color(0xFF1F3A6D);
  late Color alternate = const Color(0xFF2C2C2C);
  ...
  late Color accent1 = const Color(0xFFB0B3B5);
  late Color accent2 = const Color(0xFF6E6E6E);
  late Color accent3 = const Color(0xFFD6A800);
  late Color accent4 = const Color(0xFF4F4F4F);
  late Color success = const Color(0xFF1D6D29);
  late Color warning = const Color(0xFFBF8B00);
  late Color error = const Color(0xFFA71D2D);
  late Color info = const Color(0xFF0C4C6A);
