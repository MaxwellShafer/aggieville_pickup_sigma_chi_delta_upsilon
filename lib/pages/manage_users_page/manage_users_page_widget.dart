...
import '/components/verify_user/verify_user_widget.dart';
...
class ManageUsersPageWidget extends StatefulWidget {
  const ManageUsersPageWidget({super.key});
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          FutureBuilder<List<UserRequestsRecord>>(
                            future: queryUserRequestsRecordOnce(),
                            builder: (context, snapshot) {
                              ...
                              List<UserRequestsRecord>
                                  listViewUserRequestsRecordList =
                                  snapshot.data!;
                              ...
                              return ListView.builder(
                                ...
                                itemCount:
                                    listViewUserRequestsRecordList.length,
                                itemBuilder: (context, listViewIndex) {
                                  final listViewUserRequestsRecord =
                                      listViewUserRequestsRecordList[
                                          listViewIndex];
                                  return VerifyUserWidget(
                                    key: Key(
                                        'Key17d_${listViewIndex}_of_${listViewUserRequestsRecordList.length}'),
                                    userRequest: listViewUserRequestsRecord,
                                  );
                                },
                              );
                            },
                        ...
                        return ListView.builder(
                          ...
                          itemBuilder: (context, listViewIndex) {
                            ...
                            return UserListItemWidget(
                              key: Key(
                                  'Keyqx6_${listViewIndex}_of_${listViewUsersRecordList.length}'),
